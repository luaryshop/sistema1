...
ALTER TABLE `purchase_order_items` ADD CONSTRAINT `purchase_order_items_supplier_product_id_supplier_products_id_fk` FOREIGN KEY (`supplier_product_id`) REFERENCES `supplier_products`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `supply_alerts` ADD CONSTRAINT `supply_alerts_supplier_product_id_supplier_products_id_fk` FOREIGN KEY (`supplier_product_id`) REFERENCES `supplier_products`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
